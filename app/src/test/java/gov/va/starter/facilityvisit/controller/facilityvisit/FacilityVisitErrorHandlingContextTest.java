...
class FacilityVisitErrorHandlingContextTest {
  ...
  private FacilityVisitRequest request = new FacilityVisitRequest(defaultFacilityVisit.getFacilityId(), defaultFacilityVisit.getType(), defaultFacilityVisit.getVisitorIcn(), defaultFacilityVisit.getLastName());
  private FacilityVisit model = new FacilityVisit(defaultFacilityVisit.getFacilityId(), defaultFacilityVisit.getType(), defaultFacilityVisit.getVisitorIcn(), defaultFacilityVisit.getLastName());
  ...
  void whenHttpMessageNotReadable_thenReturns400() throws Exception {
    ...
    String requestMessage =
        "{ \"facilityId\": null, \"type\": null, \"visitorIcn\": null, \"lastName\": null}";
