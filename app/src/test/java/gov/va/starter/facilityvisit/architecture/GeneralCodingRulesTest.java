package gov.va.starter.facilityvisit.architecture;
...
public class GeneralCodingRulesTest {
  private final String packageName = "gov.va.starter.facilityvisit";
  ...
  public void noFieldInjection() {
    GeneralCodingRules.NO_CLASSES_SHOULD_USE_FIELD_INJECTION.check(
        classes.that(resideOutsideOfPackage("gov.va.starter.facilityvisit.config")));
  }
