...
public class FacilityVisitRequestMapperTest {
  ...
  private FacilityVisit createFacilityVisit(String id) {
    return new FacilityVisit(id, defaultFacilityVisitData.getUserName(), defaultFacilityVisitData.getPii(), defaultFacilityVisitData.getFirstName(), defaultFacilityVisitData.getLastName());
  }
  ...
  private FacilityVisitRequest createFacilityVisitRequest() {
    return new FacilityVisitRequest(defaultFacilityVisitData.getUserName(), defaultFacilityVisitData.getPii(), defaultFacilityVisitData.getFirstName(), defaultFacilityVisitData.getLastName());
  }
  ...
  protected void verifyFacilityVisit(FacilityVisit resource) {
    assertThat(resource.getUserName().equals(defaultFacilityVisitData.getUserName()));
